...
describe BonusDrink do
  ...
  # specify { expect(BonusDrink.total_count_for(14)).to eq 19 }
  # specify { expect(BonusDrink.total_count_for(32)).to eq 47 }
  ...
  specify { expect(BonusDrink.total_count_for(100)).to eq 138 }
